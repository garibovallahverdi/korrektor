      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center animate-fade-in">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
            <button
              className="bg-red-500 flex font-semibold cursor-pointer items-center hover:bg-red-600 text-white px-8 py-2 gap-4 rounded-lg text-lg hover-scale"
            >
              Mətni yoxla
              <ArrowRight className="ml-2 h-5 w-5" />
            </button>
            <button 
              className="px-8 py-2 rounded-lg text-lg border border-slate-300 hover:bg-sky-50 cursor-pointer"
            >
              Demo göster
            </button>
          </div>
